...
<div id="main-container" class="container-fluid">
    ...
    <section id="why" class="row" data-title="<?= $topTitleTwo; ?>" data-target="why">
        ...
        <div class="col-sm-5 col-md-4 col-md-pull-1 col-lg-2 col-lg-push-2 text-overlay-right">
            <div class="featured-content copy"><h1><?= $topTitleTwo; ?></h1><h2><?= $bottomTitleTwo; ?></h2><?= $descriptionTwo; ?></div>
        </div>
    </section>
    ...
    <section id="purpose-bottom" class="row footer-wrapper" data-title="PURPOSE!" style="background-image:url('<?= $imageSix; ?>');">
            <div class="container">
                <div id="whw" class="row whw-container" >
                    <div class="col-sm-3 col-sm-push-2 col-md-2 col-md-push-6">
                        <div class="cta-content">
                            <h2><?= $ctaTitleOne; ?></h2><p><?= $why; ?></p>
                        </div>
                    </div>
                    <div class="col-sm-3 col-sm-push-2 col-md-2 col-md-push-6">
                        <div class="cta-content">
                    ...
                    <div class="col-sm-3 col-sm-push-2 col-md-2 col-md-push-6">
                        <div class="cta-content">
                            ...
                            <div class="btn btn-success btn-large">
                                <a href="#" data-toggle="modal" data-target="#contactModal" class="">Let's Begin</a>
                            </div>
                        </div>
                    </div>
                </div>
